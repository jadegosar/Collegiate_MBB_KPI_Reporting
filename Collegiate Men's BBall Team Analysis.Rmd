...
MBB_CMJ_All_Trials <- read_excel("cmj_example.xlsx")
...
MBB_game_info_22_23 <- read_excel("schedule_example.xlsx", 
    sheet = "22-23")
MBB_game_info_21_22 <- read_excel("schedule_example.xlsx", 
    sheet = "21-22")
...
min_played <- read_excel("min_played.xlsx", 
    sheet = "Min Played")
...
min_played_long_clean$Athlete <- ifelse(min_played_long_clean$Athlete == "Example Player Name",
                                            "Cleaned Player Name",
                                            ifelse(min_played_long_clean$Athlete == "Example Player Name ",
                                                   "Cleaned Player Name", min_played_long_clean$Athlete))
...
JJ_Ratings$Athlete <- ifelse(JJ_Ratings$Athlete == "Example Player Name",
                                            "Cleaned Player Name",
                                            ifelse(JJ_Ratings$Athlete == "Example Player Name",
                                                   "Cleaned Player Name", JJ_Ratings$Athlete))
